    ...
    <div>
      ...
      <div className="p-6 space-y-5 max-w-3xl">
        ...
        <div className="flex items-start gap-3 bg-red-50 border border-red-200 rounded-xl px-5 py-3.5">
          ...
          <Link href="/staff/alerts" className="text-xs font-medium text-red-600 hover:text-red-800 shrink-0 mt-0.5">
            View →
          </Link>
        </div>
        ...
        <DashCard>
          <div className="flex justify-between items-center mb-4">
            ...
            <Link href="/staff/log-visit" className="text-xs font-medium text-trust-600 hover:text-trust-700">
              + Log new
            </Link>
          </div>
